...
def appendDataFile(dataFile_path, plaxis_password, foundationWidth, E_min, E_max, ecc_min, ecc_max,soilLayerThickness, soilModel):
	data = dict()
...
for i in range(calculationsToRun):
	appendDataFile(dataFile_path, plaxis_password, foundationWidth, E_min, E_max, ecc_min, ecc_max,soilLayerThickness,soilModel)
